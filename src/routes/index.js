...
//const { obtenerAutoresLibros, obtenerAutoresLibrosId, crearAutoresLibros, actualizarAutoresLibros, eliminarAutoresLibros } = require('../controllers/index.controller');

//const { obtenerCategorias, obtenerCategoriasId, crearCategorias, actualizarCategorias, eliminarCategorias } = require('../controllers/index.controller');

//const { obtenerCategoriasLibros, obtenerCategoriasLibrosId, crearCategoriasLibros, actualizarCategoriasLibros, eliminarCategoriasLibros } = require('../controllers/index.controller');

//const { obtenerLibros, obtenerLibrosId, crearLibros, actualizarLibros, eliminarLibros } = require('../controllers/index.controller');
